...
<footer class="pv3 ph3 ph5-ns tc">
  <a class="link near-black hover-silver dib h2 w2 mr3" href="https://github.com/sirselim" title="GitHub">
  ...
  <a class="link hover-silver near-black dib h2 w2 mr3" href="https://twitter.com/miles_benton" title="Twitter">
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M16 3.038c-.59.26-1.22.437-1.885.517.677-.407 1.198-1.05 1.443-1.816-.634.375-1.337.648-2.085.795-.598-.638-1.45-1.036-2.396-1.036-1.812 0-3.282 1.468-3.282 3.28 0 .258.03.51.085.75C5.152 5.39 2.733 4.084 1.114 2.1.83 2.583.67 3.147.67 3.75c0 1.14.58 2.143 1.46 2.732-.538-.017-1.045-.165-1.487-.41v.04c0 1.59 1.13 2.918 2.633 3.22-.276.074-.566.114-.865.114-.21 0-.416-.02-.617-.058.418 1.304 1.63 2.253 3.067 2.28-1.124.88-2.54 1.404-4.077 1.404-.265 0-.526-.015-.783-.045 1.453.93 3.178 1.474 5.032 1.474 6.038 0 9.34-5 9.34-9.338 0-.143-.004-.284-.01-.425.64-.463 1.198-1.04 1.638-1.7z" fill-rule="nonzero"/></svg>
  </a>
  <a class="link hover-silver near-black dib h2 w2 mr3" href="https://scholar.google.co.nz/citations?user=iEhBavEAAAAJ&hl=en" title="Google Scholar">
  ...
  <a class="link hover-silver near-black dib h2 w2 mr3" href="http://orcid.org/0000-0003-3442-965X" title="ORCID">
...
<div class="dt dt--fixed">
  <div class="dtc tc pv4 bg-white">
    <a href="https://www.linkedin.com/in/leah-kemp-80a204115/?originalSubdomain=nz">
      <img src="images/Leah.jpeg" width="240px" height="250px"> 
      <div class="caption">Leah Kemp</div>
    </a>
  </div>
  <div class="dtc tc pv4 bg-white">
    <a href="https://scholar.google.com/citations?user=z2edTLkAAAAJ&hl=en">
      <img src="images/JoepPM.jpg" width="300px" height="250px"> 
      <div class="caption">Dr Joep de Ligt</div>
    </a>
  </div>
  <div class="dtc tc pv4 bg-white">
    <a href="https://scholar.google.co.nz/citations?user=HtgLI-8AAAAJ&hl=en">
      <img src="images/donia.jpg" width="180px" height="250px"> 
      <div class="caption">Dr Donia Macartney-Coxson</div>
    </a>
  </div>
</div>
...
## ESR GitHub: [https://github.com/ESR-NZ](https://github.com/ESR-NZ)

<br>

* Alignment and Variant Calling Workflow: [human_genomics_pipeline](https://github.com/ESR-NZ/human_genomics_pipeline)
...
## the exact same workflow, but THE SPEED!

--

### pipeline [CPU]

* Exomes: a >100X exome takes between 8 - 12 hours
* Genomes: a ~30X genome takes between 30-48 hours
...
* Exomes: a >100X exome takes between **6-12 mins**
* Genomes: a 100X genome takes **~4 hours** (fastq -> vcf)
...
* This is running on 2x Nvidia Tesla V100 GPUs  
  * ~$15,000 NZD per card

<br>

* Can have up to 8 cards in a node
  * this results in processing a genome in **~30 mins**
      + according to Nvidia
...
.center[(*cough ... someone should ask why we don't just all buy GPUs ...*)]
...
<article class="center mw5 mw6-ns br3 hidden ba b--black-10 mv4">
  <h1 class="f4 bg-near-white br3 br--top black-60 mv0 pv2 ph3">What is Scout?</h1>
