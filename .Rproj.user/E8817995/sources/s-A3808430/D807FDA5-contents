---
title: Workshop - Methlyation and EWAS
author: Miles Benton
date: 2017-05-31T10:00:33+12:00
slug: ewas-workshop
categories: [workshop]
tags: []
description: 'an introduction to working with methylation data and epigenome-wide associatation studies'
topics: []
---
...
You can download this repository as a zip file (see https://github.com/sirselim/methylation_EWAS_workshop) and extract to the folder `methylation_EWAS_workshop` where appropriate on your system.
